...
const OFT_STRINGS = [
    'de' => [
        'Free alerts' => 'Kostenlose Benachrichtigungen',
        'Privacy' => 'Datenschutz',
        'Free tender alerts' => 'Kostenlose Ausschreibungs-Benachrichtigungen',
        'Get free email alerts' => 'Kostenlose E-Mail-Benachrichtigungen',
        'No account. One-click unsubscribe.' => 'Kein Konto. Abmeldung mit einem Klick.',
        'Your email' => 'Ihre E-Mail-Adresse',
        'Anywhere' => 'Überall',
        'Everything' => 'Alle Kategorien',
        'Keywords (optional)' => 'Stichwörter (optional)',
        'Create my alert' => 'Benachrichtigung einrichten',
        'e.g. road resurfacing' => 'z. B. Straßensanierung',
    ...
    'fr' => [
        'Free alerts' => 'Alertes gratuites',
        'Privacy' => 'Confidentialité',
        'Free tender alerts' => 'Alertes gratuites sur les appels d\'offres',
        'Get free email alerts' => 'Recevoir des alertes par e-mail',
        'No account. One-click unsubscribe.' => 'Sans compte. Désabonnement en un clic.',
        'Your email' => 'Votre adresse e-mail',
        'Anywhere' => 'Partout',
        'Everything' => 'Toutes les catégories',
        'Keywords (optional)' => 'Mots-clés (facultatif)',
        'Create my alert' => 'Créer mon alerte',
        'e.g. road resurfacing' => 'ex. réfection de chaussée',
    ...
    'es' => [
        'Free alerts' => 'Avisos gratuitos',
        'Privacy' => 'Privacidad',
        'Free tender alerts' => 'Avisos gratuitos de licitaciones',
        'Get free email alerts' => 'Recibir avisos por correo',
        'No account. One-click unsubscribe.' => 'Sin cuenta. Baja con un clic.',
        'Your email' => 'Su correo electrónico',
        'Anywhere' => 'Cualquier país',
        'Everything' => 'Todas las categorías',
        'Keywords (optional)' => 'Palabras clave (opcional)',
        'Create my alert' => 'Crear mi aviso',
        'e.g. road resurfacing' => 'p. ej. repavimentación',
    ...
    'it' => [
        'Free alerts' => 'Avvisi gratuiti',
        'Privacy' => 'Privacy',
        'Free tender alerts' => 'Avvisi gratuiti sulle gare',
        'Get free email alerts' => 'Ricevi avvisi via e-mail',
        'No account. One-click unsubscribe.' => 'Nessun account. Disiscrizione con un clic.',
        'Your email' => 'La tua e-mail',
        'Anywhere' => 'Ovunque',
        'Everything' => 'Tutte le categorie',
        'Keywords (optional)' => 'Parole chiave (facoltative)',
        'Create my alert' => 'Crea il mio avviso',
        'e.g. road resurfacing' => 'es. rifacimento stradale',
    ...
    'pl' => [
        'Free alerts' => 'Bezpłatne powiadomienia',
        'Privacy' => 'Prywatność',
        'Free tender alerts' => 'Bezpłatne powiadomienia o przetargach',
        'Get free email alerts' => 'Otrzymuj powiadomienia e-mail',
        'No account. One-click unsubscribe.' => 'Bez konta. Rezygnacja jednym kliknięciem.',
        'Your email' => 'Twój adres e-mail',
        'Anywhere' => 'Wszędzie',
        'Everything' => 'Wszystkie kategorie',
        'Keywords (optional)' => 'Słowa kluczowe (opcjonalnie)',
        'Create my alert' => 'Utwórz powiadomienie',
        'e.g. road resurfacing' => 'np. remont nawierzchni',
    ...
    'pt' => [
        'Free alerts' => 'Alertas gratuitos',
        'Privacy' => 'Privacidade',
        'Free tender alerts' => 'Alertas gratuitos de concursos',
        'Get free email alerts' => 'Receber alertas por e-mail',
        'No account. One-click unsubscribe.' => 'Sem conta. Cancelamento com um clique.',
        'Your email' => 'O seu e-mail',
        'Anywhere' => 'Qualquer país',
        'Everything' => 'Todas as categorias',
        'Keywords (optional)' => 'Palavras-chave (opcional)',
        'Create my alert' => 'Criar o meu alerta',
        'e.g. road resurfacing' => 'ex. repavimentação',
    ...
    'nl' => [
        'Free alerts' => 'Gratis meldingen',
        'Privacy' => 'Privacy',
        'Free tender alerts' => 'Gratis aanbestedingsmeldingen',
        'Get free email alerts' => 'Ontvang gratis e-mailmeldingen',
        'No account. One-click unsubscribe.' => 'Geen account. Afmelden met één klik.',
        'Your email' => 'Uw e-mailadres',
        'Anywhere' => 'Overal',
        'Everything' => 'Alle categorieën',
        'Keywords (optional)' => 'Trefwoorden (optioneel)',
        'Create my alert' => 'Melding aanmaken',
        'e.g. road resurfacing' => 'bijv. wegdekvernieuwing',
